        ...
        <div class="card-body">
            <form action="/buku" method="POST" enctype="multipart/form-data">
                ...
                <div class="form form-group">
                    ...
                    <input type="text" name="judul_buku" id="" class="form form-control">
                @error('judul_buku')
                    <small>{{ $message }}</small>
                @enderror
                </div>
                <div class="form form-group">
                    <small>Penulis</small>
                <input type="text" name="penulis" id="" class="form form-control">
                @error('penulis')
                    <small>{{ $message }}</small>
                @enderror
                </div>
                ...
                <input type="text" name="tahun_terbit" id="" class="form form-control">
                @error('tahun_terbit')
                    <small>{{ $message }}</small>
                @enderror
                </div>
